...
// prize add for camera by tangcong 20210407 start
        ...
        {
                SENSOR_DRVNAME_S5KGM1STGMS_MIPI_RAW,
                {
                        {RST, Vol_Low, 0},
                        {DVDD, Vol_1000, 0},
                        {AVDD, Vol_2800, 0},
...
#endif
// prize add for camera by tangcong 20210407 end
...
// prize add for camera by zhuzhengjiang 20200109 start
	...
	{
		SENSOR_DRVNAME_S5K3P3SXGMS_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
	...
	{
		SENSOR_DRVNAME_S5K3P3SXGQ_MIPI_RAW,
		{
			{SensorMCLK, Vol_High, 0},
			{DOVDD, Vol_1800, 0},
			{AVDD, Vol_2800, 0},
