...
#define KEY_GESTURE_LEFT                        511//KEY_LEFT
#define KEY_GESTURE_RIGHT                       510//KEY_RIGHT
#define KEY_GESTURE_O                           512//KEY_O
#define KEY_GESTURE_E                           518//KEY_E
#define KEY_GESTURE_M                           520//KEY_M
#define KEY_GESTURE_L                           521//KEY_L
#define KEY_GESTURE_W                           514//KEY_W
#define KEY_GESTURE_S                           515//KEY_S
#define KEY_GESTURE_V                           513//KEY_V
#define KEY_GESTURE_C                           519//KEY_C
#define KEY_GESTURE_Z                           516//KEY_Z
...
//prize add by lipengpeng 20201130 start 
int Gesture_Mode=0;
...
//prize add by lipengpeng 20201201 start
int gesture_set_openmode(int state){
	struct fts_ts_data *ts_data = fts_data;
	int ret=0;
	mutex_lock(&ts_data->input_dev->mutex);
	if(0==state)
...
//prize add by lipengpeng 20201201 end 
...
//prize add by lipengpeng 20201130 start 
	fts_read_reg(0xd3, &state);
    memcpy(buf, data, FTS_GESTURE_DATA_LEN);
    //if (buf[0] != ENABLE) {
    //    printk("gesture not enable in fw, don't process gesture");
    //    return 1;
    //}
//prize add by lipengpeng 20201130 end 
...
//prize add by lipengpeng 20201130 start 
    ...
    fts_gesture_report(input_dev, state);
//prize add by lipengpeng 20201130 start 
    return 0;
}
