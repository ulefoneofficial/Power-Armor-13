...
//prize add by lipengpeng 20200315 start
#ifdef CONFIG_PRIZE_TYPEC_POSITIVE_NEGATIVE
	printk("lpp---cc1=%d,cc2=%d  tcpc_dev->typec_attach_new=%d\n",typec_get_cc1(),typec_get_cc2(),tcpc_dev->typec_attach_new);
...
{
	if(((typec_get_cc1()==0)&&(typec_get_cc2()==5))||((typec_get_cc1()==0)&&(typec_get_cc2()==7))){
		typeccharge_det=1;
	}
	else if(((typec_get_cc1()==5)&&(typec_get_cc2()==0))||((typec_get_cc1()==7)&&(typec_get_cc2()==0))){
			typeccharge_det=0;
		}	
	else{
			typeccharge_det= -1;
...
#if defined(CONFIG_PRIZE_NE6153_SUPPORT) || defined(CONFIG_PRIZE_WIRELESS_RECEIVER_MAXIC_MT5715) || defined(CONFIG_PRIZE_CV8035D_SUPPORT) || defined(CONFIG_PRIZE_MT5725_SUPPORT_15W)
		set_otg_gpio(1);
#endif
