...
static uint16_t aw88195_base_addr[] = {
	AW88195_SPK_REG_ADDR,
	AW88195_SPK_DSP_FW_ADDR,
	AW88195_SPK_DSP_CFG_ADDR,
	AW88195_VOICE_REG_ADDR,
	AW88195_VOICE_DSP_FW_ADDR,
	AW88195_VOICE_DSP_CFG_ADDR,
	AW88195_FM_REG_ADDR,
	AW88195_FM_DSP_FW_ADDR,
	AW88195_FM_DSP_CFG_ADDR,
 ...
 *
 ******************************************************/
static int aw88195_reg_writes(struct aw881xx *aw88195,
	uint8_t reg_addr, uint8_t *buf, uint16_t len)
{
	int ret = -1;

	ret = aw881xx_reg_writes(aw88195, reg_addr, buf, len);
	if (ret < 0)
...
/*
static int aw88195_reg_reads(struct aw881xx *aw88195,
	uint8_t reg_addr, uint8_t *buf, uint16_t len)
{
	int ret = -1;

	ret = aw881xx_reg_reads(aw88195, reg_addr, buf, len);
	if (ret < 0)
...
static int aw88195_reg_write(struct aw881xx *aw88195,
	uint8_t reg_addr, uint16_t reg_data)
{
	int ret = -1;

	ret = aw881xx_reg_write(aw88195, reg_addr, reg_data);
	if (ret < 0)
...
static int aw88195_reg_read(struct aw881xx *aw88195,
	uint8_t reg_addr, uint16_t *reg_data)
{
	int ret = -1;

	ret = aw881xx_reg_read(aw88195, reg_addr, reg_data);
	if (ret < 0)
...
static int aw88195_reg_write_bits(struct aw881xx *aw88195,
	uint8_t reg_addr, uint16_t mask, uint16_t reg_data)
{
	int ret = -1;

	ret = aw881xx_reg_write_bits(aw88195, reg_addr, mask, reg_data);
	if (ret < 0)
...
void aw88195_set_cali_re(void *aw881xx)
{
	...
	aw88195_dsp_read(aw88195, AW88195_DSP_REG_CFG_ADPZ_RA,
		&dsp_ra);

	cali_re = aw88195->cali_re + dsp_ra;
...
static void aw88195_run_mute(struct aw881xx *aw88195, bool mute)
{
	...
	if (mute) {
		aw88195_reg_write_bits(aw88195, AW88195_REG_PWMCTRL,
...
void aw88195_run_pwd(void *aw881xx, bool pwd)
{
	...
	if (pwd) {
		aw88195_reg_write_bits(aw88195, AW88195_REG_SYSCTRL,
...
static void aw88195_memclk_select(struct aw881xx *aw88195, unsigned char flag)
{
	...
	if (flag == AW88195_MEMCLK_PLL) {
		aw88195_reg_write_bits(aw88195, AW88195_REG_SYSCTRL2,
...
static int aw88195_sysst_check(struct aw881xx *aw88195)
{
	...
	for (i = 0; i < AW88195_SYSST_CHECK_MAX; i++) {
		aw88195_reg_read(aw88195, AW88195_REG_SYSST, &reg_val);
		if ((reg_val & (~AW88195_BIT_SYSST_CHECK_MASK)) ==
			AW88195_BIT_SYSST_CHECK) {
			ret = 0;
			return ret;
		} else {
			pr_info("%s: check fail, cnt=%d, reg_val=0x%04x\n",
				__func__, i, reg_val);
			msleep(2);
		}
	}
...
static int aw88195_get_sysint(struct aw881xx *aw88195, uint16_t *sysint)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_SYSINT, &reg_val);
	if (ret < 0)
...
static int aw88195_get_dsp_status(struct aw881xx *aw88195)
{
	...
	aw88195_reg_read(aw88195, AW88195_REG_WDT, &reg_val);
	if (reg_val)
		ret = 0;
...
int aw88195_get_dsp_config(void *aw881xx)
{
	...
	aw88195_reg_read(aw88195, AW88195_REG_SYSCTRL, &reg_val);
...
int aw88195_get_hmute(void *aw881xx)
{
	...
	aw88195_reg_read(aw88195, AW88195_REG_PWMCTRL, &reg_val);
...
static int aw88195_get_icalk(struct aw881xx *aw88195, int16_t *icalk)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_EFRM, &reg_val);
...
static int aw88195_get_vcalk(struct aw881xx *aw88195, int16_t *vcalk)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_EFRL, &reg_val);
...
static int aw88195_set_intmask(struct aw881xx *aw88195, bool flag)
{
	int ret = -1;

	if (flag)
		ret = aw88195_reg_write(aw88195, AW88195_REG_SYSINTM,
			aw88195->intmask);
	else
		ret = aw88195_reg_write(aw88195, AW88195_REG_SYSINTM,
			AW88195_REG_SYSINTM_MASK);
	return ret;
}

static int aw88195_start(void *aw881xx)
{
	struct aw881xx *aw88195 = (struct aw881xx *)aw881xx;
	...
	if (ret < 0) {
		...
		aw88195_set_intmask(aw88195, true);

		if ((aw88195->monitor_flag) &&
			((aw88195->scene_mode == AW881XX_SPK_MODE) ||
			(aw88195->scene_mode == AW881XX_VOICE_MODE) ||
			(aw88195->scene_mode == AW881XX_FM_MODE))) {
...
static void aw88195_stop(void *aw881xx)
{
	struct aw881xx *aw88195 = (struct aw881xx *)aw881xx;

	pr_debug("%s: enter\n", __func__);

	aw88195_set_intmask(aw88195, false);
	aw88195_run_mute(aw88195, true);
	...
	struct aw88195_container *aw88195_cont, uint16_t base)
{
...
#ifdef AW88195_DSP_I2C_WRITES
	/* i2c writes */
	aw88195_reg_write(aw88195, AW88195_REG_DSPMADD, base);
	...
	for (i = 0; i < aw88195_cont->len;
		...
		aw88195_reg_writes(aw88195, AW88195_REG_DSPMDAT,
	...
	for (i = 0; i < aw88195_cont->len; i += 2) {
		...
		aw88195_reg_write(aw88195, AW88195_REG_DSPMDAT, reg_val);
	}
#endif
	pr_debug("%s: exit\n", __func__);
}
...
void aw88195_get_volume(void *aw881xx, unsigned int *vol)
{
	...
	aw88195_reg_read(aw88195, AW88195_REG_HAGCCFG7, &reg_val);
	vol_val = (reg_val >> AW88195_VOL_REG_SHIFT);
	*vol = (vol_val >> 4) * AW88195_VOL_6DB_STEP +
		((vol_val & 0x0f) % AW88195_VOL_6DB_STEP);
}
...
void aw88195_set_volume(void *aw881xx, unsigned int vol)
{
	...
	/* cal real value */
	vol_val = ((vol / AW88195_VOL_6DB_STEP) << 4) +
		(vol % AW88195_VOL_6DB_STEP);
	reg_val = (vol_val << AW88195_VOL_REG_SHIFT);

	/* write value */
	aw88195_reg_write_bits(aw88195, AW88195_REG_HAGCCFG7,
...
int aw88195_update_hw_params(void *aw881xx)
{
	...
	/* set chip rate */
	aw88195_reg_write_bits(aw88195, AW88195_REG_I2SCTRL,
...
void aw88195_interrupt_setup(void *aw881xx)
{
	...
	aw88195_reg_read(aw88195, AW88195_REG_SYSINTM, &reg_val);
	reg_val &= (~AW88195_BIT_SYSINTM_PLLM);
	reg_val &= (~AW88195_BIT_SYSINTM_OTHM);
	reg_val &= (~AW88195_BIT_SYSINTM_OCDM);
	aw88195_reg_write(aw88195, AW88195_REG_SYSINTM, reg_val);
}
...
void aw88195_interrupt_handle(void *aw881xx)
{
	...
	aw88195_reg_read(aw88195, AW88195_REG_SYSINT, &reg_val);
	...
	struct aw881xx *aw88195, uint16_t *reg_val)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_HAGCCFG7, reg_val);
	...
	uint16_t gain_value)
{
	...
	ret = aw88195_reg_write(aw88195, AW88195_REG_HAGCCFG7, reg_val);
	if (ret < 0)
		return ret;
	...
	struct aw881xx *aw88195, uint16_t *reg_val)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_SYSCTRL2, reg_val);
	...
	uint16_t bst_ipeak)
{
	...
	ret = aw88195_reg_write(aw88195, AW88195_REG_SYSCTRL2, reg_val);
	if (ret < 0)
		return ret;
	...
	uint16_t *voltage)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_VBAT, voltage);
	if (ret < 0)
		return ret;
	...
	struct aw881xx *aw88195, int16_t *temp)
{
	...
	ret = aw88195_reg_read(aw88195, AW88195_REG_TEMP, &reg_val);
	if (ret < 0)
		return ret;
	...
	uint16_t *bst_ipeak, uint16_t *gain_db)
{
	...
	if (voltage > AW88195_VOL_LIMIT_40) {
		...
		*gain_db = AW88195_GAIN_00DB;
		aw88195->pre_vol_bst_ipeak = *bst_ipeak;
		aw88195->pre_vol_gain_db = *gain_db;
		...
		*bst_ipeak = aw88195->pre_vol_bst_ipeak;
		*gain_db = aw88195->pre_vol_gain_db;
	}
	...
	uint16_t *gain_db, uint16_t *vmax)
{
	...
	if (temperature > AW88195_TEMP_LIMIT_7) {
		...
		*vmax = AW88195_VMAX_50;
		...
		if (temperature == pre_temp) {
			*bst_ipeak = aw88195->pre_temp_bst_ipeak;
			*gain_db = aw88195->pre_temp_gain_db;
			*vmax = aw88195->pre_temp_vmax;
		} else {
	...
	aw88195->pre_temp_bst_ipeak = *bst_ipeak;
	aw88195->pre_temp_gain_db = *gain_db;
	aw88195->pre_temp_vmax = *vmax;
