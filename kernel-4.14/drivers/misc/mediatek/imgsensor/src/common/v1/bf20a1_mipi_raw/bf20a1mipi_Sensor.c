...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.linelength = 794,                //record different mode's linelength
		.framelength = 494,            //record different mode's framelength
...
static void sensor_init(void)
{
	...
	write_cmos_sensor( 0x73, 0x05 );//for mipi  0x04
