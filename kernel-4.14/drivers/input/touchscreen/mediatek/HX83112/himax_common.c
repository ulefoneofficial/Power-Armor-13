...
{
//#include "K6505_HLT_Kubee_CIDFF20_D00_C02_20200116.i"
//prize by ycj 
//#include "K6505_HLT_Kubee_CIDFF20_D00_C04_0407-030112.i"
#include "K6505_HLT_Kubee_CID4300_D00_C07_0113-020030.i"
};
#endif
...
static void himax_report_points(struct himax_ts_data *ts)
{
    ...
    if (hx_point_num != 0 )
    {
        ...
        for (loop_i = 0; loop_i < ts->nFinger_support; loop_i++)
        {
            ...
            //x = ic_data->HX_X_RES - x;//prize wyq 2020011 mirro y
