...
/*prize-add anhengxuan 20201215 add tp hardwareinfo begin*/
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
#include "../../../../misc/mediatek/hardware_info/hardware_info.h"

extern struct hardware_info current_tp_info;
#endif
/*prize-add anhengxuan 20201215 add tp hardwareinfo end*/
...
get_app_info:
	...
	/*prize-add anhengxuan 20201215 add tp hardwareinfo begin*/
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
	sprintf(current_tp_info.chip,"td4321:%02x%02x%02x%02x - %02x", tcm_hcd->app_info.customer_config_id[0], 
	tcm_hcd->app_info.customer_config_id[1],tcm_hcd->app_info.customer_config_id[2],tcm_hcd->app_info.customer_config_id[3],tcm_hcd->app_info.customer_config_id[4]);
#endif
	/*prize-add anhengxuan 20201215 add tp hardwareinfo end*/
...
/* prize modify hw reset by liaoxingen 升级固件后开机有时tp无触问题 20210608 start */
	if (1/*hw*/) {
/* prize modify hw reset by liaoxingen 升级固件后开机有时tp无触问题 20210608 end */
		if (bdata->reset_gpio < 0) {
			LOGE(tcm_hcd->pdev->dev.parent,
...
/*prize-add anhengxuan 20201215 add tp hardwareinfo begin*/
#if defined(CONFIG_PRIZE_HARDWARE_INFO)
    sprintf(current_tp_info.id,"0x%02x",0x80);
