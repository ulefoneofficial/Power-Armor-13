...
#elif defined (CONFIG_PROJECT_DAOGE_S7)
static unsigned char config_info[SIZE_BATINFO] = {
    #include "S7_Profile_8000mAh_profile_BRZH470X_20210317.i"
};
#elif defined (CONFIG_PROJECT_DAOGE_S7S88B7)
static unsigned char config_info[SIZE_BATINFO] = {
    #include "S7S88B7_Profile_8000mAh_profile_BRZH470X_20210409.i"
};
#else
static unsigned char config_info[SIZE_BATINFO] = {
...
#ifdef CONFIG_PRIZE_ZERO_PERCENT_POWER_OFF
...
#ifdef CONFIG_PRIZE_ZERO_PERCENT_POWER_OFF
	int now_charge_current;
	int counts = 0;
	now_charge_current = battery_get_bat_current();
#endif
//prize add by lipengpeng 20201226 end 	
...
//prize add by lipengpeng 20201226 start 
#ifdef CONFIG_PRIZE_ZERO_PERCENT_POWER_OFF
	if((cw_capacity == 0)&&(now_charge_current < 0))
	{
		while (counts < 5) {
            mdelay(250);
