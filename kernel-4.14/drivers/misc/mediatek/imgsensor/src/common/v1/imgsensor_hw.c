...
/*prize add by zhuzhengjiang for compate same sensor 20210202 start*/
int curr_sensor_id =0;
/*prize add by zhuzhengjiang for compate same sensor 20210202 end*/
extern void  regulator_afvdd_set(int status);/* prize add by zhuzhengjiang for otp 20210302 start*/
