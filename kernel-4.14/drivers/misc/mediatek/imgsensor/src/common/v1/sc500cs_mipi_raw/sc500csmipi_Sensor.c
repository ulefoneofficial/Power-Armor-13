...
#define LOG_2 LOG_INF("preview 2592*1944@30fps,960Mbps/lane; video 2592*1944@30fps,960Mbps/lane; capture 2592*1944@30fps,960Mbps/lane\n")
...
static struct imgsensor_info_struct imgsensor_info = {
	...
	.pre = {
		...
		.linelength = 1600,				//record different mode's linelength
...
/**********************************************************************************************************************/
//$MIPI[Width:2592,Height:1944,Format:RAW10,Lane:2,ErrorCheck:0,PolarityData:0,PolarityClock:0,Buffer:4,DataRate:960,useEmbData:0]
//$MV1[MCLK:24,Width:2592,Height:1944,Format:MIPI_RAW10,mipi_lane:2,mipi_datarate:960,pvi_pclk_inverse:0]
//=====================================================
// SC500CS
// Fullsize mode
// X_output size : 2592
// Y_output size : 1944
// Frame_rate : 30.00 fps
// Output_format RAW 10
// Output_lanes 2
// Output_clock_mhz : 960 Mhz
// System_clock_mhz : 96 Mhz
...
{
	LOG_INF("E! hs_video_setting - currefps:%d\n",currefps);
	preview_setting();
}
...
{
	LOG_INF("E! slim_video_setting - currefps:%d\n",currefps);
	preview_setting();
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id) 
{
    ...
    while (imgsensor_info.i2c_addr_table[i] != 0xff) {
        ...
        spin_unlock(&imgsensor_drv_lock);
        do {
			*sensor_id = ((read_cmos_sensor(0x3107) << 8) | read_cmos_sensor(0x3108));
            if (*sensor_id == imgsensor_info.sensor_id) {               
                printk("sc500cs-i2c write id: 0x%x, sensor id: 0x%x\n", imgsensor.i2c_write_id,*sensor_id);      
                return ERROR_NONE;
            }   
            printk("sc500cs-Read sensor id fail, write id: 0x%x, sensor id = 0x%x\n", imgsensor.i2c_write_id,*sensor_id);
            retry--;
        } while(retry > 0);
        i++;
        retry = 2;
