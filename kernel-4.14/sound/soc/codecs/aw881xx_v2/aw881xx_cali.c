...
//prize modified by huarui , 20201101 start
//#define AWINIC_CALI_FILE  "/mnt/vendor/persist/factory/audio/aw_cali.bin"
#define AWINIC_CALI_FILE  "/dev/block/by-name/proinfo" //prize add by huarui ,support hs
//prize modified by huarui , 20201101 end
...
//	snprintf(buf, PAGE_SIZE, "%10u", cali_re);
	...
	pos += 3072; //prize add by huarui ,support hs
