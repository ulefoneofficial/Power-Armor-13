...
{
   //[chenpeng] [20190704] [start] 
    #if 1//def 1//AGOLD_DW9800W_AF_OPTIMIZE
	int pos = g_u4CurrPosition;
	int pos_size = 6;
    int step_num =0;
	int step = 0;
	if(pos > 470)
		step_num = (pos-470)/pos_size;
	else
		step_num = (470 - pos)/pos_size;
	#endif	
	//[chenpeng] [20190704] [end] 
	LOG_INF("Start\n");
	...
	//[chenpeng] [20190704] [start]	
        ...
        s4AF_WriteReg(470);
        msleep(20);  
        LOG_INF("[DW9800WAF]Move to ini pos\n");
    #endif 
    //[chenpeng] [20190704] [end]   
	}
