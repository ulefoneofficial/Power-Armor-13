...
/*prize-slove tp compatible crash--anhengxuan--20201112,start*/
#define SYNA_I2C_SLAVE_ADDR 0x2c
/*prize-slove tp compatible crash--anhengxuan--20201112,end*/
...
#endif
/*prize-slove tp compatible crash--anhengxuan--20201112,start*/
if(i2c->addr!=SYNA_I2C_SLAVE_ADDR)
{
   i2c->addr=SYNA_I2C_SLAVE_ADDR;
}
/*prize-slove tp compatible crash--anhengxuan--20201112,end*/
	bus_io.type = BUS_I2C;
