...
static void lcm_panel_init(struct lcm *ctx)
{
	...
	lcm_dcs_write_seq_static(ctx, 0xCD, 0x1D,0x00,0xEA,0xED,0xFC,0xEA,0x29,0x2B);
...
static const struct of_device_id lcm_of_match[] = {
	{ .compatible = "visionox,r66455,cmd", },
	{ }
};
...
static struct mipi_dsi_driver lcm_driver = {
	...
	.remove = lcm_remove,
	.driver = {
		.name = "panel-visionox-r66455-cmd",
		.owner = THIS_MODULE,
