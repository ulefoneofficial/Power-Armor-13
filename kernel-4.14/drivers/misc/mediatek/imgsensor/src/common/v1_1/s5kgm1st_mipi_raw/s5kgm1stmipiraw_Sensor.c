 ...
 *************************************************************************/
 ...
 #define GM1ST_MODULE_ID_OFFSET  0x0001
static kal_uint16 read_module_id_gm1st(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(GM1ST_MODULE_ID_OFFSET >> 8), (char)(GM1ST_MODULE_ID_OFFSET & 0xFF)};
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint16 module_id = 0,gm1st_id = 0;
	...
	//prize add by lipengpeng 20200215 start
		gm1st_id = read_module_id_gm1st();
	printk("lppxxxx,gm1st_id=%x",gm1st_id);
	if(gm1st_id !=0x28){
