...
#include "s5kgm1stgmsmipiraw_Sensor.h"
...
#define PFX "s5kgm1stgms_camera_sensor"
/****************************   Modify end	**************************/
...
#ifdef VENDOR_EDIT
#define DEVICE_VERSION_S5KGM1STGMS    "s5kgm1stgms"
...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = S5KGM1STGMS_SENSOR_ID,
...
static kal_int32 write_Module_data(ACDK_SENSOR_ENGMODE_STEREO_STRUCT * pStereodata)
{
	...
	if(pStereodata != NULL) {
		...
		if ((pStereodata->uSensorId == S5KGM1STGMS_SENSOR_ID)
				&& (data_base == 0x1640)
				&& (data_length == 1561)) {
...
//prize add by lipengpeng 20210401 start
 #define GM1STGMS_MODULE_ID_OFFSET  0x0001
static kal_uint16 read_module_id_gm1stgms(void)
{
	kal_uint16 get_byte = 0;
	char pusendcmd[2] = {(char)(GM1STGMS_MODULE_ID_OFFSET >> 8), (char)(GM1STGMS_MODULE_ID_OFFSET & 0xFF)};

	iReadRegI2C(pusendcmd, 2, (u8 *)&get_byte, 1, 0xA0/*EEPROM_READ_ID*/);
	pr_err("the module s5kgm1st id is %d\n", get_byte);
	return get_byte;
}
...
static kal_uint32 get_imgsensor_id(UINT32 *sensor_id)
{
	kal_uint8 i = 0;
	kal_uint8 retry = 2;
	kal_uint16 module_id = 0,gm1stgms_id = 0;
	...
	//prize add by lipengpeng 20200215 start
			...
			gm1stgms_id = read_module_id_gm1stgms();
	printk("lppxxxx,gm1stgms_id=%x",gm1stgms_id);
	if(gm1stgms_id !=0x26){
		...
		do {
			*sensor_id = ((read_cmos_sensor_8(0x0000) << 8) | read_cmos_sensor_8(0x0001))+1;
			...
			if (*sensor_id == imgsensor_info.sensor_id) {
				...
				//add by wq 	register_imgsensor_deviceinfo("Cam_b", DEVICE_VERSION_S5KGM1STGMS, module_id);
				 ...
				 UINT8 *feature_para, UINT32 *feature_para_len)
{
	...
	case SENSOR_FEATURE_GET_PDAF_REG_SETTING:
		LOG_INF("SENSOR_FEATURE_GET_PDAF_REG_SETTING %d",
			(*feature_para_len));
		s5kgm1stgms_get_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
	case SENSOR_FEATURE_SET_PDAF_REG_SETTING:
		 ...
		 *	(*feature_para_len));
		 */
		s5kgm1stgms_set_pdaf_reg_setting((*feature_para_len) / sizeof(UINT32)
					   , feature_data_16);
		break;
#endif
...
UINT32 S5KGM1STGMS_MIPI_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
	...
	if (pfFunc != NULL)
		*pfFunc = &sensor_func;
	return ERROR_NONE;
} /* s5kgm1stgms_MIPI_RAW_SensorInit */
