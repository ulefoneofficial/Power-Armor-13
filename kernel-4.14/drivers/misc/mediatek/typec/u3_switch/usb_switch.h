...
struct usb_switch
{
	int usb_switch_irq_num;
	int usb_switch_irq_gpio;
};
...
struct usbc_pin_ctrl {
	...
	struct pinctrl_state *switch_usb_init;
	struct pinctrl_state *switch_usb_high;
	struct pinctrl_state *switch_usb_low;
};
